...
# 向量数据库路径
vecdb_directory: str = os.path.join(os.path.dirname(os.path.abspath(sys.argv[0])), "vecdb")

# 存放图像摘要的文件夹的路径
docs_directory: str = os.path.join(os.path.dirname(os.path.abspath(sys.argv[0])), "docs")

# 存放图像的文件夹的路径
imgs_directory: str = os.path.join(os.path.dirname(os.path.abspath(sys.argv[0])), "imgs")
